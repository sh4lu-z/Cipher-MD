...
Our EULA was last updated on 2026/06/26

Please read this End-User License Agreement carefully before clicking
the \"I Agree\" button, downloading or using Cipher-MD.
...
- \"**Agreement**\" means this End-User License Agreement that forms the
  ...
  Application. This EULA was generated by [TermsFeed EULA
  Generator](https://www.termsfeed.com/eula-generator/).

- \"**Application**\" means the software program provided by the Company
  downloaded by You through an Application Store\'s account to a Device,
  named Cipher-MD
...
- \"**Application Store**\" means the digital distribution service
  ...
  (Google Play Store) by which the Application has been downloaded to
  your Device.

- \"**Company**\" (referred to as either \"the Company\", \"We\", \"Us\"
  or \"Our\" in this Agreement) refers to **Syntiox, a company
...
not click on the \"I Agree\" button, do not download or do not use the
Application.
...
Application and its content. Although the Application Store is not a
party to this Agreement, it has the right to enforce it against You as a
third party beneficiary relating to your use of the Application.
...
You may only use the Application on a Device that You own or control and
as permitted by the Application Store\'s terms and conditions.
...
settlement and discharge of any claim that the Application or your use
...
be disclaimed, the Company, not the Application Store, shall be solely
...
You under any theory of liability for any direct, indirect, incidental,
...
- By visiting this page on our website: https://cipher-md.vercel.app/

- By sending us an email: hello@shalukagimhan.com
